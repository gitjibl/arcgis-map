...
<script>
import EsriMap from "./package/esri-map/index.vue";
import EsriMapPopup from "./package/esri-map/components/esri-map-popup/EsriMapPopup.vue";
export default {
  data() {
    return {
  ...
  components: { EsriMap, EsriMapPopup },
};
</script>
<style scoped>
/* @import url(); 引入css类 */
